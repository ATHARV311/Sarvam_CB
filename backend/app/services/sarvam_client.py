...
class SarvamClient:
    def __init__(self):
        # ─── HARDCODE OVERRIDE FOR DIAGNOSTICS ───
        self.api_key = "sk_tpf2ghdu_iCHDVt42d0ov0whhXwBbCXmf"
        self.base_url = "https://api.sarvam.ai"
        self.is_demo = False
        
        print(f"🚀 FORCE BOOT: Sarvam client initialized with direct key override!")
